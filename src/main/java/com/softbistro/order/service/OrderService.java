...
public class OrderService {
	...
	public void firstCheckout(BookForOrder book) throws JsonProcessingException, JSONException {
		System.out.println(postToApiString(checkoutFirstList, URL_FIRST_CHECKOUT + book.getOrderId() + "/CHECKOUTV3"));
	}

	public String firstEvaluateCheckout(BookForOrder book) throws  JsonProcessingException, JSONException {
	...
	public Integer createOrder(BookForOrder book) throws JsonProcessingException, JSONException {
