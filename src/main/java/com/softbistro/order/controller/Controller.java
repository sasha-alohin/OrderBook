...
public class Controller {
	...
	public void firstCheckout(@RequestBody BookForOrder book) throws JsonProcessingException, JSONException {
		service.firstCheckout(book);
	}

	@RequestMapping(value = "/firstEvaluateCheckout", method = RequestMethod.POST, produces = "application/json")
	public void firstEvaluateCheckout(@RequestBody BookForOrder book) throws JsonProcessingException,JSONException {
	...
	public Integer createOrder(@RequestBody BookForOrder book) throws JsonProcessingException,JSONException {
